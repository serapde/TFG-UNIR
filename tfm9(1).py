...
## Clasificación de rentabilidades futuras de valores bursátiles mediante redes neuronales convolucionales
...
def tfmmodel(train_X, train_label,valid_X, valid_label,test_X, test_Y_one_hot):
  ...
  Parada_Temprana = EarlyStopping(monitor='val_loss', mode='max', patience = 4, verbose=1)
